...
render(){
    return(
        <div >
           ...
           <a onMouseEnter={this.handle} className="brand-logo logx left"><span className="logshvv red-text
           ">O</span><span className="logsh yellow-text ">O</span><span className="logshv blue-text">O</span>cean parade</a>
